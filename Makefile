...
extract-bin:
	espflash save-image --chip esp32s3 target/xtensa-esp32s3-none-elf/release/rustdio rustdio-release.bin

flash-monitor-debug: ## flash and monitor
...
monitor-release:
	espflash monitor -L defmt --elf target/xtensa-esp32s3-none-elf/release/rustdio
